...
Whether we know it or not, in these moments we are considering the Form of this system. In this idealised notion, the system is 100% available, as secure as a nuclear bunker, easy to debug, uses a thimble of memory, runs in constant time and deploys everywhere instantly. It's unrealistic, but that's the point, it's the Platonic Ideal of the system.

Some devs are much more concerned about this than others. Others just want to ship new features and Get Stuff Done. There is a rough correlation here between the dichotomy of focussing on optimisation and developer experience versus accumulating [tech debt](https://en.wikipedia.org/wiki/Technical_debt) and shipping new features. In my experience these things *aren't always mutually exclusive,* but there is a spectrum of attitudes here and this also varies depending on the team or project as well. It's also probably wise to mention the ["premature optimisation is the root of all evil"](https://en.wikipedia.org/wiki/Program_optimization#cite_ref-autogenerated268_5-0) take here.

If you can identify where your team sits on the spectrum of idealifying versus featurifying, it will help you understand their motivations and drives, and also help highlight pain points in the product or the developer experience that may end up coming back to bite you later. A good example might be issues bringing up a local dev environment; sooner or later, you'll have a new dev on your team or someone from another team will need to work on your domain and you'll need to spend a 3 hour call walking them through all the workarounds you need to get started. yikes!

In short, this is a very elaborate way of saying: if you listen closely to the feelings of your dev team and how much of an appetite they have for building new features, you'll probably learn some useful things. Maybe even [canary-in-the-coalmine](https://www.smithsonianmag.com/smart-news/story-real-canary-coal-mine-180961570/) things.
